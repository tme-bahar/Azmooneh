...
public class MarkTyping extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_question_page_type2_for_marking);
        ...
        TextView questionGrade = findViewById(R.id.textView32);
        TextView answer = findViewById(R.id.textView35);
        EditText mark = findViewById(R.id.editTextNumber2);
        ...
        answer.setText(ans == null ? "" : ans.getAnswer());
        if(ans != null)
    ...
    private boolean save(String Grade,float max,Answer answer){
        ...
        try {
            float grade = (float) Double.parseDouble(Grade);
            if(grade > max){
